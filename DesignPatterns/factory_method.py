"""
Factory method é um padrão de criação que permite definir uma interface(classe abstrata) para criar objetos, mas
deixa as subclasses decidirem quais objetos criar. O factory method permite adiar a instanciação para as subclasses,
